...
$stmt = $pdo->prepare('SELECT products.id, products.product_image, products.product_name, products.price FROM products');
$stmt->execute();
        ...
        <div class="col-sm-6 col-md-3">
          <div class="product-card">
            <div class="product-info mb-3">
              ...
              <h5 class="title"><?=trim($product['product_name'])?></h5>
              
              <h3 class="price">&dollar;<?=trim($product['price'])?></h3>
            </div>
